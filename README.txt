...
2) open CMD
3) Paste this command: git clone https://github.com/Redlook096/Amelia-AI2.0.git
4) Paste this command: rename Amelia-AI2.0 Amelia2.0
5) Type Command: cd Amelia2.0
6) Type Command: python3 Amelia2.0.py
